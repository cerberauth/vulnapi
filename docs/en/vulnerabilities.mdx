...
| [JWT Psychic Signature](./vulnerabilities/broken-authentication/jwt-psychic-signature)               | API2:2023 Broken Authentication             | High     | ✅ |
| [JWT JWK Header Injection](./vulnerabilities/broken-authentication/jwt-jwk-injection)                 | API2:2023 Broken Authentication             | High     | ✅ |
| [JWT JKU Header Injection](./vulnerabilities/broken-authentication/jwt-jku-injection)                 | API2:2023 Broken Authentication             | High     | ✅ |
| [JWT X5C Header Injection](./vulnerabilities/broken-authentication/jwt-x5c-injection)                 | API2:2023 Broken Authentication             | High     | ✅ |
| [JWT X5U Header Injection](./vulnerabilities/broken-authentication/jwt-x5u-injection)                 | API2:2023 Broken Authentication             | High     | ✅ |
| [JWT Signature not verified](./vulnerabilities/broken-authentication/jwt-not-verified)               | API2:2023 Broken Authentication             | High     | ✅ |
| [JWT Claim Fuzzing](./vulnerabilities/broken-authentication/jwt-claim-fuzzing)                       | API8:2023 Security Misconfiguration         | Medium   | ✅ |
