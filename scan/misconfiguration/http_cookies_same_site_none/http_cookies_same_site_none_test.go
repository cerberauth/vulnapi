package httpcookiessamesitenone_test
...
func runCheck(op *operation.Operation, store harnessx.ResultStore) (harnessx.Result, error) {
	resource := harnessx.Resource{ID: op.ID, URL: op.URL.String(), Method: op.Method, Data: op}
	return httpcookiessamesitenone.Check.RunResource(context.Background(), harnessx.Target{URL: op.URL.String()}, resource, store)
}

func TestHTTPCookiesSameSiteNone_Skipped_WhenNoCookies(t *testing.T) {
...
func TestHTTPCookiesSameSiteNone_Passed_WhenNoUnsecurePractices(t *testing.T) {
	client := request.GetDefaultClient()
	httpmock.ActivateNonDefault(client.Client)
	defer httpmock.DeactivateAndReset()
...
func TestHTTPCookiesSameSiteNone_Failed_WhenSameSiteNone(t *testing.T) {
	client := request.GetDefaultClient()
	httpmock.ActivateNonDefault(client.Client)
	defer httpmock.DeactivateAndReset()
...
func TestHTTPCookiesSameSiteNone_Passed_WhithoutSameSite(t *testing.T) {
	client := request.GetDefaultClient()
	httpmock.ActivateNonDefault(client.Client)
	defer httpmock.DeactivateAndReset()
